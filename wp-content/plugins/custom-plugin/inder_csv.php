        ...
        if ($file) {
            ...
            while (($row = fgetcsv($file)) !== false) {
                ...
                if (empty($post_content)){
                     $error_message = "Description is required.";// fallback to title
                }
            ...
            foreach ($rows as $post_data) {
                ...
                if (empty($post_content)) {
                    $post_content = $post_title; // fallback again just in case
                }
            ...
            if ($posts_created > 0) {
                echo '<p><strong>' . $posts_created . ' posts created successfully.</strong></p>';
            } else {
                echo '<p><strong>No posts were created.</strong></p>';
            }
        } else {
